...
### 2. 字形本土化
将大部分汉字调整为更符合陆标的字形，少部分汉字或部件为维持原有风格，保留原有字形或采用折衷写法。 \
![2](./images/2.png)
...
## 备注
- 本人并非专业的字体设计师，且字数庞大，制作时间跨度较长，制作方法又经过多次调整，因此难免会出现部分汉字的质量或风格参差不齐的状况。（例如早期有一部分字采用了横向压缩和手工加粗的拼字方法，该方法会带来加粗痕迹明显、笔画末端会出现重复的点等问题，后期改用 Inkscape LPE 偏移的方法，质量有所改善）
